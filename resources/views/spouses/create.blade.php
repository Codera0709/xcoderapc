<x-layout.layout>
    <x-slot name="title">Tambah Data Spouse - XCODERA</x-slot>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Data Spouse</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Isi form di bawah untuk menambahkan data spouse untuk {{ $person->nama_lengkap }}</p>
            </div>
        </div>
        ...
        <x-ui.card>
            <form method="POST" action="{{ route('spouses.store', $person->id) }}">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 rounded">
                    ...
                    <div>
                        ...
                        <input type="text" name="spouse_nik" value="{{ old('spouse_nik') }}" maxlength="16" required
                    ...
                    <div>
                        ...
                        <input type="text" name="spouse_nama_lengkap" value="{{ old('spouse_nama_lengkap') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="spouse_tempat_lahir" value="{{ old('spouse_tempat_lahir') }}" required
                    ...
                    <div>
                        ...
                        <input type="date" name="spouse_tanggal_lahir" value="{{ old('spouse_tanggal_lahir') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="spouse_pekerjaan" value="{{ old('spouse_pekerjaan') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="spouse_kewarganegaraan" value="{{ old('spouse_kewarganegaraan', 'WNI') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="spouse_berlaku_hingga" value="{{ old('spouse_berlaku_hingga', 'SEUMUR HIDUP') }}" required
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_rt" value="{{ old('spouse_rt') }}" maxlength="3" required
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_rw" value="{{ old('spouse_rw') }}" maxlength="3" required
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_kelurahan" value="{{ old('spouse_kelurahan') }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_kecamatan" value="{{ old('spouse_kecamatan') }}" required
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_kabupaten_kota" value="{{ old('spouse_kabupaten_kota') }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_provinsi" value="{{ old('spouse_provinsi') }}" required
