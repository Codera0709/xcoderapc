<x-guest-layout>
    ...
    <x-slot name="subtitle">Welcome back! Please enter your details</x-slot>
        ...
        <div>
            ...
            <div class="relative" x-data="{ showPassword: false }">
                ...
                <input 
                    ...
                    class="block w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:text-white transition-colors"
                    placeholder="••••••••"
                />
                <button 
                    type="button"
